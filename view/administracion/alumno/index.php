		...
		<div class="col-xs-12">
	  		<div class="box">
	    		<div class='box-header with-border'> 
	      			...
	      			<a class="btn btn-sm btn-primary pull-right" href="?c=Alumno&a=v_Registrar"> Alumno Nuevo</a>
	    		</div>
	    		<!-- llamado   F listar del controlador -->
                  	...
                  	<table id="TablaEntidad" class="table table-bordered table-hover dataTable no-footer" width="100%">
	                    ...
	                    <tbody>
	                    	...
	                    	<tr>
                                ...
                                <td class=""><span class="label label-success"><i 
								class="fa fa-check-square-o" aria-hidden="true"></i> Activo</span></td>
                                <?php else: ?>
                                <td class=""><span class="label label-danger"><i 
								class="fa fa-square-o" aria-hidden="true"></i> Inactivo</span></td>
                                <?php endif ?>
                            	<td class="a_center">                            		
                            		<a href="?c=Alumno&a=v_Actualizar&idAlumno=<?php 
									echo $alumno['idAlumno']; ?>" class="btn btn-primary btn-xs " 
									data-toggle="tooltip" data-placement="top" title="Actualizar">
                                   		<i class="fa fa-pencil"></i>   
                               		</a>
                               		<a class="btn btn-danger btn-xs EliminarAlumno" 
									data-id="<?php echo $alumno['idAlumno']; ?>" data-alumno="<?php echo 
									$alumno['primer_nombre'].' '.$alumno['apellido_paterno']; ?>" data-toggle="tooltip" data-placement="top" 
									title="Eliminar">
