 ...
 private $bd;
   ...
   public function Listar()
    ...
    {     
        ...
        VALUES(:primer_nombre,:apellido_paterno,:apellido_materno,:edad,:dni,
        :fecha_nacimiento,:curso,:carrera,:ingresado_por)");
...
// llamo a los datos del curso por la id
    ...
    public function Actualizar(Alumno $alumno)
    {
        ...
        apellido_materno=:apellido_materno, edad=:edad, dni=:dni,
        fecha_nacimiento=:fecha_nacimiento,curso=:curso, carrera=:carrera,
    ...
    public function Eliminar(Alumno $alumno)
    {
        ...
        $this->bd = new Conexion();
        $stmt = $this->bd->prepare("UPDATE alumno SET  modificado_por=:modificado_por,
        eliminado=:eliminado WHERE idAlumno = :idAlumno");
